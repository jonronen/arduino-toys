...
# r7 is the nunmer of commercials
# r8 is the chosen commercial number
...
:COMMERCIAL
# r8 holds the commercial number
# r7 holds the number of commercials
RANDOM r8, r7

# commercial sounds begin at #7
SET_REG r2, 7
ADD_REGS r8, r8, r2
PLAY_SOUND_BLOCKING r8

# now jump back to the random thing
SET_REG r3, @FILL_NEXT_RANDOM
JUMP r3
